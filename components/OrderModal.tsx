...
export default function OrderModal({ onClose }: OrderModalProps) {
  ...
  return (
    ...
    >
      ...
      {/* Panel */}
      <div className="relative bg-brand-dark w-full sm:max-w-md rounded-t-3xl sm:rounded-3xl shadow-2xl overflow-hidden border border-white/10">
        {/* Header */}
        <div className="px-6 pt-6 pb-5 border-b border-white/10">
          <div className="flex items-start justify-between">
            <div>
              <h2 id="order-modal-heading" className="font-poppins font-black text-xl text-white">
            ...
            <button
              onClick={onClose}
              className="text-gray-500 hover:text-white transition-colors p-1.5 -mr-1 -mt-1 rounded-lg hover:bg-white/10"
